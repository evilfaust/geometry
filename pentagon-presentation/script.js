...
const steps = [
  ...
  },
  {
    ...
    description: "Через точки A и B проведи прямую f. Затем через точку A построй прямую g, перпендикулярную прямой f. Эти две прямые помогут найти остальные опорные точки.",
    note: "Иначе говоря, из точки A нужно провести перпендикуляр именно к прямой AB.",
  },
  {
    part: "Часть 2. Ключевые точки",
    title: "Шаг 4. Отметь точку C",
    description: "Прямая f пересекает окружность c в двух точках. Одна из них уже отмечена как B, а вторую точку на этой же прямой обозначь буквой C.",
    note: "Точки B и C лежат напротив друг друга, поэтому отрезок BC является диаметром окружности.",
  },
  {
    part: "Часть 2. Ключевые точки",
  ...
  },
  {
    ...
    description: "Посмотри, где прямая g пересекает основную окружность c выше точки A. Эту верхнюю точку пересечения обозначь буквой E.",
    note: "Нужна именно верхняя точка, потому что дальше построение продолжается в верхней части окружности.",
  },
  {
  ...
  },
  {
    ...
    description: "Окружность d пересекает прямую f в двух точках. Левую точку, которая лежит между C и A, обозначь буквой F. Правую точку пересечения обозначь буквой G: она тоже получилась из пересечения той же окружности d с прямой f, но дальше остается только вспомогательной.",
    note: "Для построения стороны пятиугольника используется отрезок EF, а точка G нужна только как дополнительная отметка второго пересечения.",
  },
  {
