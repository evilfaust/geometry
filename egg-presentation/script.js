...
const steps = [
  ...
  },
  {
    ...
    note: "В GeoGebra первая точка пересечения совпадает с B, а нужная нам новая точка — это D.",
  },
  {
  ...
  },
  {
    ...
    note: "Точка F находится выше E и левее него, как на исходном чертеже GeoGebra.",
  },
  {
    part: "Часть 4. Точки стыка дуг",
