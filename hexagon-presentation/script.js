...
const steps = [
  {
    ...
    description: "Возьми точку C как центр будущей окружности. На нужном расстоянии от нее отметь точку D: отрезок CD станет радиусом окружности.",
    note: "Этот же радиус потом будет равен стороне правильного шестиугольника.",
  },
  {
    part: "Часть 1. Основная окружность",
    title: "Шаг 2. Построй окружность с центром в C",
    description: "Поставь иглу циркуля в точку C, раствором CD проведи окружность. Точка D уже лежит на этой окружности.",
    note: "Именно на окружности будут отмечаться все шесть вершин шестиугольника.",
  },
  {
    part: "Часть 2. Диаметр",
    title: "Шаг 3. Проведи прямую DC и отметь точку G",
    description: "Проведи прямую через точки D и C. Она пересечет окружность еще раз с другой стороны. Эту вторую точку пересечения обозначь буквой G.",
    note: "Точки D и G лежат напротив друг друга на окружности.",
  },
  {
    part: "Часть 3. Новые вершины",
    title: "Шаг 4. Из точки D отметь точки B и E",
    description: "Не меняя раствор циркуля, поставь иглу в точку D и проведи вспомогательную окружность. Она пересечет основную окружность в двух точках. Обозначь верхнюю точку B, а нижнюю — E.",
    note: "Получились еще две вершины шестиугольника, потому что радиус окружности равен его стороне.",
  },
  {
    part: "Часть 3. Новые вершины",
    title: "Шаг 5. Из точки G отметь точки A и F",
    description: "Тем же раствором циркуля поставь иглу в точку G и проведи вторую вспомогательную окружность. Точки ее пересечения с основной окружностью обозначь A и F.",
    note: "Теперь на окружности отмечены все шесть вершин: A, B, D, E, F и G.",
  },
  {
    part: "Часть 4. Финал",
    title: "Шаг 6. Соедини вершины по порядку",
    description: "Соедини точки A → B → D → E → F → G → A. Получится правильный шестиугольник.",
    note: "Все стороны равны, потому что они откладывались одним и тем же раствором циркуля.",
  },
];
...
const orderedPoints = ["A", "B", "D", "E", "F", "G"];
  ...
  return `
    <svg viewBox="0 0 ${geometry.width} ${geometry.height}" role="img" aria-label="${steps[stepIndex].title}">
      ...
      <style>
        ...
        .polygon-main { fill: rgba(47, 133, 90, 0.12); stroke: ${colors.polygon}; stroke-width: 4; stroke-linejoin: round; }
      </style>
      ${layers.join("")}
      ${pointsMarkup}
    </svg>
